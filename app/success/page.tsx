...
export default function SuccessPage() {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      if (!values.name || !values.email || !values.intention || !validDate) {
        setError("Start a demo booking first so the velvet rope knows who you are.");
        return;
      }
  ...
  return (
    <main className="success-page">
        ...
        <section className="confirmation-card">
          ...
          <div className="confirmation-card__content">
            ...
            <p className="confirmation-card__lead">
              ...
              imaginary calendar has officially acknowledged your existence.
            </p>
            <dl className="summary-card confirmation-card__summary">
              ...
              <div className="summary-card__total"><dt>Fantasy price</dt><dd>{money(confirmation.amount)}</dd></div>
            </dl>
            <div className="complimentary-status"><span>✦</span> No payment was collected</div>
            <div className="calendar-status calendar-status--added">
              <span /> Browser-only demo — no real calendar event was created
            </div>
      ...
      <p className="success-page__disclaimer">
        Private entertainment demo · No payment collected · No dating, escort,
